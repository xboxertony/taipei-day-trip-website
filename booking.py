...
def api_book():
	...
	if request.method=="GET":
		...
		sql = f"SELECT attractionId,name,address,images2,date,time,price,bookingorder,booking.id FROM attraction.booking inner join attraction.attractions on attractionId=attractions.id where userid = '{idx}' or email = '{email}' or FB_ID = '{fb_id}' order by bookingorder"
